...
export default function FetchTest() {
  ...
  const { loading, errorMessage, fetchUser: user}
  ...
  return (
    <section className="mt-4">
      ...
      <div className="flex justify-center mt-4">
        ...
        <Button className="btn-sm btn btn-accent" onClick={changeName}>
          change name
        </Button>
        <Button className="btn-sm btn btn-success" onClick={changeEmail}>
          change email
        </Button>
        <Button className="btn-sm btn btn-secondary" onClick={changePicture}>
          change picture
        </Button>
      </div>
      {loading && (
