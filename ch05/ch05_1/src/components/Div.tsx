...
export const Div: FC<DivProps> = ({
  ...
  left,right,top,bottom,minWidth,minHeight,maxHeight,maxWidth, ...props
}) => {
  const style= {..._style , width,height , backgroundImage: src 
    && `url(${src})`,left,right,top,bottom,minHeight,maxHeight,maxWidth}
