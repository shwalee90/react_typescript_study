...
export default function ObjectState() {
  ...
  const onCahangeEmail = useCallback((e: ChangeEvent<HTMLInputElement>) => {
      ...
      <div className="flex justify-center mt-4">
        <form onSubmit={onSubmit}>
          ...
          <div className="form-control">
            ...
            <input value={form.email} onChange={onCahangeEmail} id="email" type="email"
            placeholder="enter your email" className="input input-primary"/>
          </div>
          <div className="flex mt-4 justiry-center">
